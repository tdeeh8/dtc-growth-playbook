...
Use playbook benchmarks and frameworks when analyzing data and forming recommendations. Cite the playbook when making recommendations (e.g., "Per the three-layer framework, Layer 1 should use Reach/ThruPlay objectives...").
