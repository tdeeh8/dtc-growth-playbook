...
1. Read the full skill file: `.claude/skills/meta-ads-v2/SKILL.md`
...
3. Read all reference files in `.claude/skills/meta-ads-v2/reference/` before opening the browser.
