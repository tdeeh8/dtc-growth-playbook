...
The user invokes `/audit-shopify` optionally followed by a client name (e.g., `/audit-shopify Acme Co`).
...
- `${CLAUDE_PLUGIN_ROOT}/references/measurement.md` (Shopify = financial source of truth, MER, blended metrics)
