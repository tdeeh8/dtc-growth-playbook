---
name: meta-ads-audit-v2
description: "Run a deep Meta Ads platform audit — campaign structure, creative performance, audience targeting, attribution, Advantage+ assessment — then write a standardized evidence JSON file. Triggers on: 'audit their Meta', 'Meta Ads audit', 'audit Facebook campaigns', 'creative performance audit', 'Meta attribution audit'."
---
...
> **Read shared ref first:** `audit-shared/reference/audit-lifecycle.md` for standard setup (manifest check, evidence directory, AOV-conditional loads).

### Meta-Specific Setup

**Platform playbook chunks** (load before opening browser):
- `references/andromeda.md` — Andromeda algorithm, Entity ID clustering, creative diversity, fatigue
- `references/scaling-frequency.md` — frequency ceilings, audience saturation, scaling sequence
- `references/measurement.md` — tracking validation, CAPI/EMQ, Meta Jan 2026 attribution changes

**Conditional loads** (per lifecycle ref AOV rules, plus):
- Creative deep dive → `references/creative-testing.md`
- Campaign architecture focus → `references/tof-strategy.md` (canonical for ASC setup, budget splits, retargeting)

**Skill reference files** (load all before browsing):
- `reference/nav-meta.md` — Ads Manager navigation, column customization, breakdown extraction
- `reference/creative-checklist.md` — *Phase-gated: load at Phase 3*
- `reference/audience-checklist.md` — *Phase-gated: load at Phase 4*
...
1. Open Meta Ads Manager → correct ad account. **Set date range immediately** (see `reference/nav-meta.md`). Default: YTD.
2. **Customize columns** (defaults are insufficient — see `reference/nav-meta.md` for exact column set):
...
> **Phase-gated load:** Read `reference/creative-checklist.md` now. Follow its full checklist.

1. **Navigate to ad-level view.** Customize columns for creative metrics (see `reference/nav-meta.md`).
...
> **Phase-gated load:** Read `reference/audience-checklist.md` now. Follow its full checklist.
...
> **Phase-gated load:** Read `references/andromeda.md` and `references/scaling-frequency.md` now if not loaded at setup.
...
> **Read shared ref:** `audit-shared/reference/evidence-schema-quick.md` for schema structure.
...
> **Evidence labeling:** Follow `audit-shared/reference/evidence-rules.md`. Meta-specific source format: "Meta Ads Manager > [page] > [section] > [metric] (custom columns)".
...
> Follow `audit-shared/reference/audit-lifecycle.md` → "After the Audit" section.

---

## Working Notes Protocol

> **Template:** Follow `audit-shared/reference/audit-lifecycle.md` → "Working Notes Template" section.
...
> **Full benchmarks:** `references/benchmarks.md`. Only critical Meta thresholds below.
...
> **Core rules:** Follow `audit-shared/reference/evidence-rules.md` in full.
