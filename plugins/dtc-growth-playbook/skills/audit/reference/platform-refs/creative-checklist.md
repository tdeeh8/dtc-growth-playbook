...
Reference for the meta-ads-audit-v2 audit skill. Systematic checklist for Meta creative performance assessment, fatigue detection, and diversity analysis. Draws from `reference/playbook/andromeda.md` (canonical source for creative fatigue and Entity ID clustering) and `reference/playbook/benchmarks.md` (creative metric thresholds).
