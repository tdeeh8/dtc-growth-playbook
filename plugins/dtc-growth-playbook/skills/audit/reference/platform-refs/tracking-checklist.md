...
Reference for the google-ads-audit-v2 audit skill. Systematic checklist for Google Ads conversion tracking health assessment. Draws heavily from `reference/playbook/measurement.md` (Tracking Validation section).
