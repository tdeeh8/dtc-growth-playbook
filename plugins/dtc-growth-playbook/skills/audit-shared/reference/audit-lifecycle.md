...
|-----|-----------------|-------|
| >$200 | `references/high-ticket.md` | Extended consideration, BNPL, social proof |
| <$100 | `references/low-ticket.md` | Impulse funnel, checkout friction, offer structures |
...
- **Disruptive clients:** `{evidence_dir}/{Client}_audit_manifest.md`
- **{client_name}:** `{evidence_dir}/{Client}_audit_manifest.md`
