...
Full schema: `audit-orchestrator/reference/evidence-schema.json`
...
| meta-ads | campaign_details, creative_details, audience_details |
...
Labels (5-label system): OBSERVED, CALCULATED, INFERENCE, ASSUMPTION, DATA_NOT_AVAILABLE — see `audit-shared/reference/evidence-rules.md`
